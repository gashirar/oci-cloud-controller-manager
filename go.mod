module github.com/gashirar/oci-cloud-controller-manager
...
require (
	...
	github.com/kubernetes-incubator/external-storage v4.0.0+incompatible
	...
	github.com/oracle/oci-cloud-controller-manager v0.0.0-20191127073508-89bc79cecd42
