...
| `oci-load-balancer-subnet1`                 | The OCID of the first [subnet][2] of the two required subnets to attach the load balancer to. Must be in separate Availability Domains. This will be deprecated in future releases.                                                                | Value provided in config file                    |
| `oci-load-balancer-subnet2`                 | The OCID of the second [subnet][2] of the two required subnets to attach the load balancer to. Must be in separate Availability Domains.  This will be deprecated in future releases.                                                              | Value provided in config file                    |
| `oci-load-balancer-subnets`                 | The comma separated list of OCIDs of the required [subnets][2] to attach the load balancer to. Must be in separate Availability Domains or 1 regional subnet (recommended).                                                                          | Value provided in config file                    |
